...
<html lang="en">
  <head>
    ...
    <title>RIANA BANK</title>
  </head>

  <body background="images/download1.jpg" style="background-size: 100% 100%;">
  <?php
  include 'navbar.php';
  ?>
            ...
            <div class="row intro py-1">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  <h1 >Welcome to <br>RIANA BANK</h1>
                </div>
              </div>
            </div>
      ...
      <div class="container  text-center">
          <div class="row " >
               <div class="card col-md-3 mx-auto" style="width: 18rem;">
                    <img src="images/user.jpeg" width="200" height="250" class="card-img-top mt-3 i mg" alt="Responsive image">
                    <div class="card-body">
                  ...
                  <div class="card col-md-3 mx-auto" style="width: 18rem;">
                    <img src="images/b.jpeg" width="200" height="250"class="card-img-top mt-3 i mg"alt="Responsive image">
                    <div class="card-body">
      ...
      <footer class="text-center mt-5 py-2" style= "background-color :lavendr;">
        <p>&copy 2021. Made by <b>Ridhi Rawat</b> 
      </footer>
